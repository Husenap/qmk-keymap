...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [SYM] = LAYOUT(
        ...
        _______,  MY_TILD,  SE_AT,    SE_LBRC,  SE_RBRC,  DIRUP,                            _______,  _______,  _______,  _______,  _______,  _______,
    ...
    */
    [OPS] = LAYOUT(
        _______,  _______,  _______,  _______,  _______,  _______,  _______,      _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,  SE_QUOT,  SE_LABK,  SE_RABK,  SE_DQUO,  MY_CIRC,  _______,      _______,  _______,  _______,  _______,  _______,  _______,  _______,
    ...
    [NAV] = LAYOUT(
        ...
        _______,  KC_BTN2,  KC_WH_L,  KC_BTN3,  KC_WH_R,  _______,                          _______,  _______,  _______,  _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,            _______,      _______,            _______,  _______,  _______,  _______,  _______,
                                                _______,  _______,  _______,      _______,  _______,  _______
    ),
